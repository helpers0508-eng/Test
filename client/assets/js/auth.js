...
class AuthManager {
    ...
    async handleSignup(e) {
        ...
        try {
            ...
            if (response.success) {
                ...
                window.location.href = window.APP_CONSTANTS?.ROUTES?.VERIFY_OTP || '/verify-otp';
            } else {
    ...
    logout() {
        ...
        window.location.href = window.APP_CONSTANTS?.ROUTES?.LOGIN || '/login';
    }
    ...
    redirectToDashboard() {
        ...
        const ROUTES = window.APP_CONSTANTS?.ROUTES || {
            DASHBOARD: '/dashboard',
        ...
        switch (role) {
            case 'user':
                ...
                break;
            case 'helper':
                window.location.href = ROUTES.HELPER_DASHBOARD;
                break;
            case 'admin':
