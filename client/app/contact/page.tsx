...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Error handled silently in production, logged in development
        ...
        <div className="max-w-md mx-auto text-center">
          <div className="bg-white dark:bg-background-dark rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-8">
            ...
            <button
              ...
              className="w-full px-6 py-3 bg-primary hover:bg-primary-dark text-white font-medium rounded-lg transition-colors"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={6}
                  className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-background-dark text-gray-900 dark:text-white focus:ring-2 focus:ring-primary focus:border-transparent resize-none"
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">support@helpers.com</p>
            ...
            <div className="bg-gradient-to-r from-primary to-primary-dark rounded-lg p-8 text-white">
              ...
              <Link
                href="/faq"
                className="inline-flex items-center gap-2 px-6 py-3 bg-white text-primary font-medium rounded-lg hover:bg-gray-50 transition-colors"
              >
                Visit FAQ
              </Link>
            </div>
